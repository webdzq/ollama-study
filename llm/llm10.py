...
for i in range(len(reviews)):
    ...
    print(f"评论{i+1}: ", response['response'], "\n")
...
'''
评论1:   这个熊猫公仔是我给女儿的生日礼物，她很喜欢，快递比预期提前了一天到货，我感觉它有点小，但是相比于价钱来说，它超级可爱。

提取信息：产品（熊猫公仔）的评分（好评）、价格、尺寸、快递、送礼物。  

评论2:   1. 需要一盏漂亮卧室灯, 该灯具有额外的储物功能, 价格不算太高.
2. 收货速度很快, 仅用了两天的时间就送到手了.
3. 灯的拉线出现问题, 公司迅速寄送了一根全新的灯线, 装配非常方便。
4. 之后发现有一个零件丢失了，联系客服快速解决。
5. 对我来说，这是一家关心客户和产品的优秀公司.  

评论3:   评论人员感到电动牙刷能量充满且清洁效果良好，但牙刷头较小而且不易更换刷毛。建议价格比实际价格便宜购买，也可以考虑替换刷头。  
